...
const Sidebar = () => (
    ...
    >
        <Flex direction='column' align='center' justify='space-between' h='100%'>
            <Box pt='24px'>
                <Stats direction='column' favorites={185} followers={589} likes={587} />
            </Box>
            <Flex
                w='208px'
                h='208px'
                bg='radial-gradient(ellipse, #c4ff61 -27%, #ffffff00 48%)'
                align='center'
                justify='center'
            >
                <Flex direction='column' gap='12px' align='center'>
                    <IconButton
                        ...
                        _active='none'
                    />
                    <Text fontSize='12px' fontWeight='400' color='#000000a3'>
                        Записать рецепт
                    </Text>
                </Flex>
            </Flex>
