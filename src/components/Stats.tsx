...
const Stats = ({ favorites = 0, followers = 0, likes = 0, direction = 'row' }: StatsProps) => {
    if (favorites === 0 && followers === 0 && likes === 0) return null;

    return (
        <Flex
            columnGap={direction === 'column' ? '0' : '8px'}
            direction={direction}
            rowGap={direction === 'column' ? '40px' : '0'}
        >
            {favorites > 0 && (
                <Flex align='center' px='4px'>
                    <Icon
                        mr={direction === 'column' ? '8px' : '6px'}
                        w={direction === 'column' ? '16px' : '12px'}
                        h={direction === 'column' ? '16px' : '12px'}
                    >
                    ...
                    <Text
                        color='#2db100'
                        fontSize={direction === 'column' ? '16px' : '12px'}
                        fontWeight='600'
                    >
                        {favorites}
                    </Text>
